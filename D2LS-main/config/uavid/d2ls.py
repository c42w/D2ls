...
weights_name = "ours_l3"
weights_path = "checkpoints/uavid/{}".format(weights_name)
...
resume_ckpt_path = None #"checkpoints/uavid/delta-0817l0.6/delta-0817l0.6.ckpt"  # whether continue training with the checkpoint, default None
strategy = None
