...
class CloudDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if p_ratio > self.mosaic_ratio or self.mode == "val":
    ...
    def get_img_ids(self, data_root, img_dir, mask_dir):
        img_filename_list = os.listdir(osp.join(data_root, img_dir, self.mode))
        mask_filename_list = os.listdir(osp.join(data_root, mask_dir, self.mode))
    ...
    def load_img_and_mask(self, index):
        img_id = self.img_ids[index]
        img_name = osp.join(
            self.data_root, self.img_dir, self.mode, img_id + self.img_suffix
        )
        mask_name = osp.join(
            self.data_root, self.mask_dir, self.mode, img_id + self.mask_suffix
        )
